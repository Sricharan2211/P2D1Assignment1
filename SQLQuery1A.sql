...
on primary (name='Products_Db',Filename='D:\Phase 2 Assignments\D1 Assignment 1\Products_Db.mdf',
size=24MB,MaxSize=48MB,filegrowth=8MB)
log on (name='Products_Db_log',filename='D:\Phase 2 Assignments\D1 Assignment 1\Product_Db_log.ldf')
